...
exp_name=unival_caption_stage_1_initvqa
...
restore_file=/lus/scratch/NAT/gda2204/SHARED/logs/ofa/checkpoints/vqa/unival_vqa/20_0.04_1e-4_480/checkpoint_best.pt

lr=1e-5


# ${base_log_dir}/ofa/checkpoints/caption/${exp_name}/10_0.06_6000/checkpoint_last.pt

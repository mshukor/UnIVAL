...
exp_name=unival_video_caption_stage_1_initvideoqa
...
restore_file=/lus/scratch/NAT/gda2204/SHARED/logs/ofa/checkpoints/vqa/unival_video_vqa/35_0.04_1e-4_480/checkpoint_best.pt


lr=1e-5


# ${base_log_dir}/ofa/checkpoints/caption/${exp_name}/20_0.06_6000/checkpoint_last.pt

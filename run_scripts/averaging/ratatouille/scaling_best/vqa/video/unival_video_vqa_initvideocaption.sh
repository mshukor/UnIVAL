...
restore_file=/lus/scratch/NAT/gda2204/SHARED/logs/ofa/checkpoints/caption/unival_video_caption/20_0.06_6000/checkpoint_best.pt
    ...
    for lr in {$lr,}; do
      ...
      for patch_image_size in {$patch_image_size,}; do
        ...
        python3 -m torch.distributed.launch \
            ...
            --save-interval=1 --validate-interval=1 --validate-interval-updates=${validate_interval_updates} \
            ...
            --drop-worst-ratio ${drop_worst_ratio} --drop-worst-after ${drop_worst_after} \

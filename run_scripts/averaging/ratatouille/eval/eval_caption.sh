...
exp_name=eval_caption_base_best_caption_stage_1_caption_ratacapgroundsnlivqaofapt
path=${base_log_dir}/ofa/pretrained_models/average_models/caption_ratacapgroundsnlivqaofapt.pt



echo ${path}
result_path=${base_log_dir}/ofa/results/caption/${exp_name}_${split}
mkdir ${result_path}

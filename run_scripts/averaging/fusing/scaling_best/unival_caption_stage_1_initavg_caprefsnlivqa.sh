...
exp_name=unival_caption_stage_1_initavg_caprefsnlivqa
...
# save_dir=${base_log_dir}/ofa/checkpoints/caption/${exp_name}
log_dir=${save_dir}
...
restore_file=/lus/scratch/NAT/gda2204/SHARED/logs/ofa/pretrained_models/average_models/avg_caprefsnlivqa.pt

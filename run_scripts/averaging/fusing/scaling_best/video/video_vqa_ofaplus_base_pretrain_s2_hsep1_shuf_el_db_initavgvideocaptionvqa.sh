...
exp_name=unival_video_vqa_initavgvideocaptionvqa
...
restore_file=/lus/scratch/NAT/gda2204/SHARED/logs/ofa/pretrained_models/average_models/avg_vid_capvqa.pt

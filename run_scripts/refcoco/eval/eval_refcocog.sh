...
path=/lus/scratch/NAT/gda2204/SHARED/logs/ofa/checkpoints/refcocog/unival_refcocog/checkpoint_best.pt
...
data=${base_data_dir}/ofa/refcocog_data/refcocog_val.tsv
split='refcocog_val'
...
data=${base_data_dir}/ofa/refcocog_data/refcocog_test.tsv
split='refcocog_test'

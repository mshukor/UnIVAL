...
path=/lus/scratch/NAT/gda2204/SHARED/logs/ofa/checkpoints/refcoco/unival_refcoco/checkpoint_best.pt
...
echo ${path}
result_path=${new_base_log_dir}/ofa/results/refcoco/${exp_name}
# result_path=${base_log_dir}/ofa/results/refcoco/${exp_name}
mkdir ${result_path}




data=${base_data_dir}/ofa/refcoco_data/refcoco_val.tsv
split='refcoco_val'
...
data=${base_data_dir}/ofa/refcoco_data/refcoco_testA.tsv
split='refcoco_testA'
python3 -m torch.distributed.launch \
    --nnodes=${NUM_NODES} \
    --nproc_per_node=${GPUS_PER_NODE} \
...
data=${base_data_dir}/ofa/refcoco_data/refcoco_testB.tsv
split='refcoco_testB'

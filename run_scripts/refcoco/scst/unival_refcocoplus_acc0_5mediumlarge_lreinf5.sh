...
exp_name=unival_refcocoplus_acc0_5mediumlarge_lreinf5
...
save_dir=${base_log_dir}/ofa/checkpoints/refcocoplus/${exp_name}
log_dir=${save_dir}
...
restore_file=${base_log_dir}/ofa/checkpoints/refcocoplus/unival_refcocoplus/10_3e-5_512/checkpoint_best.pt
...
criterion=refcoco_scst_reward_criterion
# label_smoothing=0.1
lr=3e-5
max_epoch=10
warmup_ratio=0.06
...
python3 -m torch.distributed.launch \
    ...
    --scst \
    --scst-args='{"beam":5,"min_len":4,"max_len_a":0,"max_len_b":4}' \
    --acc-thresh=${acc_thresh} \
    --metric=${metric} \
    --max-area-size=${max_area_size} \
    --lambda-reinforce=${lambda_reinforce} \
    ${medium_area}

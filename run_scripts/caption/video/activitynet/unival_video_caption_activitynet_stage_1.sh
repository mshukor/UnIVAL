...
exp_name=unival_video_caption_activitynet_stage_1
...
save_dir=${new_base_log_dir}/ofa/checkpoints/caption/${exp_name}
log_dir=${save_dir}
...
data=${data_dir}/activitynet_caption_train.tsv,${data_dir}/activitynet_caption_val2.tsv
eval_cider_cached=${data_dir}/cider_cached_tokens/activitynet-val2-words.p

data=${data_dir}/activitynet_caption_train_1.tsv,${data_dir}/activitynet_caption_train_2.tsv,${data_dir}/activitynet_caption_train_3.tsv,${data_dir}/activitynet_caption_train_4.tsv,${data_dir}/activitynet_caption_train_5.tsv,${data_dir}/activitynet_caption_train_6.tsv,${data_dir}/activitynet_caption_train_7.tsv,${data_dir}/activitynet_caption_train_8.tsv,${data_dir}/activitynet_caption_train_9.tsv,${data_dir}/activitynet_caption_train_10.tsv,${data_dir}/activitynet_caption_val2.tsv

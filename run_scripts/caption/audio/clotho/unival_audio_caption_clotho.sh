...
exp_name=unival_audio_caption_clotho
...
# data=${data_dir}/clotho_development.tsv,${data_dir}/clotho_evaluation.tsv

data=${data_dir}/clotho_development_1.tsv,${data_dir}/clotho_development_2.tsv,${data_dir}/clotho_development_3.tsv,${data_dir}/clotho_development_4.tsv,${data_dir}/clotho_development_5.tsv,${data_dir}/clotho_development_6.tsv,${data_dir}/clotho_development_7.tsv,${data_dir}/clotho_development_8.tsv,${data_dir}/clotho_development_9.tsv,${data_dir}/clotho_development_10.tsv,${data_dir}/clotho_evaluation.tsv
...
for warmup_ratio in {0.06,}; do
  ...
  for drop_worst_after in {6000,}; do
    ...
    python3 -m torch.distributed.launch \
        ...
        --save-interval=${save_interval} --validate-interval=${validate_interval} \

...
exp_name=eval_activitynet_video_caption
...
split=test
data=${data_dir}/activitynet_caption_val2.tsv
...
model_name=unival_video_caption_activitynet
...
# result_path=${base_log_dir}/ofa/results/caption/${model_name}_${split}
mkdir ${result_path}
...
python ${ofa_dir}/run_scripts/caption/coco_eval.py ${result_path}/${split}_predict.json ${data_dir}/activitynet_val2_caption_coco_format.json

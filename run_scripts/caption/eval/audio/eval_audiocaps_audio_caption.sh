...
exp_name=eval_audiocaps_audio_caption
...
split=test
data=${data_dir}/audiocaps_test.tsv
...
model_name=unival_audio_caption
...
python ${ofa_dir}/run_scripts/caption/coco_eval.py ${result_path}/${split}_predict.json ${data_dir}/audiocaps_test_caption_coco_format.json

...
exp_name=unival_video_vqa_msvd


image_dir=${base_data_dir}
data_dir=${base_data_dir}/ofa/video_data/vqa_data

data=${data_dir}/msvd_qa_1k_train.tsv,${data_dir}/msvd_qa_1k_test.tsv
# data=${data_dir}/msvd_qa_3k_train.tsv,${data_dir}/msvd_qa_3k_test.tsv


# Note: If you have shuffled the data in advance, please uncomment the line below.
data=${data_dir}/msvd_qa_1k_train_1.tsv,${data_dir}/msvd_qa_1k_train_2.tsv,${data_dir}/msvd_qa_1k_train_3.tsv,${data_dir}/msvd_qa_1k_train_4.tsv,${data_dir}/msvd_qa_1k_train_5.tsv,${data_dir}/msvd_qa_1k_train_6.tsv,${data_dir}/msvd_qa_1k_train_7.tsv,${data_dir}/msvd_qa_1k_train_8.tsv,${data_dir}/msvd_qa_1k_train_9.tsv,${data_dir}/msvd_qa_1k_train_10.tsv,${data_dir}/msvd_qa_1k_test.tsv

ans2label_file=${base_data_dir}/ofa/video_data/vqa_data/msvd_trainval_1k_ans2label.pkl
# ans2label_file=${base_data_dir}/ofa/video_data/vqa_data/msvd_trainval_3k_ans2label.pkl


selected_cols=0,5,2,3,4

new_base_log_dir=/lus/scratch/NAT/gda2204/SHARED/logs
save_dir=${new_base_log_dir}/ofa/checkpoints/vqa/${exp_name}

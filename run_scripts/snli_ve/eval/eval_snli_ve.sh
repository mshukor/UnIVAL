...
# model_name=avg_rata_l0_7snlirefcapvqa
# path=/lus/scratch/NAT/gda2204/SHARED/logs/ofa/pretrained_models/average_models/avg_rata_l0_7snlirefcapvqa.pt
...
result_path=${new_base_log_dir}/ofa/results/snli_ve/snli_ve_${split}_${model_name}
